...
@Path("Aanmelden")
public class AanmeldenResource {
    ...
    public Response AanmeldenUser(@FormParam("naam") String nm,@FormParam("email") String em,
                                  @FormParam("gebruikersnaam") String gn, @FormParam("wachtwoord") String ww) {
                                 // @FormParam("klas") String klas) {
        try {

            String role = Student.registerUser(nm, em, gn, ww);
            if (!(role == null)) {
